...
export class Parser implements IParser<number> {
     ...
     */
    validateSync(val?: string, options?: validator.IsIntOptions | undefined): boolean {
     ...
     * @param options radix (the second parameter in parseInt method)
     */
    async validate(val?: string, options?: validator.IsIntOptions | undefined): Promise<boolean> {
     ...
     * @param options radix (the second parameter in parseInt method)
     */
    parseSync(val?: string, options?: number | undefined): number {
     ...
     * @param options radix (the second parameter in parseInt method)
     */
    async parse(val?: string, options?: number | undefined): Promise<number> {
     ...
     */
    validateAndParseSync(val?: string, defaultValue?: number, options?: { validatorOptions?: validator.IsIntOptions | undefined, parserOptions?: number | undefined }): number | undefined {
     ...
     * @param options Contains both validator and parser options
     */
    async validateAndParse(val?: string, defaultValue?: number, options?: { validatorOptions?: validator.IsIntOptions | undefined, parserOptions?: number | undefined }): Promise<number | undefined> {
